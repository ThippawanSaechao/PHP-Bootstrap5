                    ...
                    <div class="app-utilities col-auto">
                        <div class="app-utility-item app-user-dropdown dropdown">
                            <a class="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">
                                <img src="upload/admin/<?=$_SESSION['image_login']?>" class="rounded-circle" alt="user profile" /> <?=$_SESSION['user_login']?>
                            </a>
    ...
    <div id="app-sidepanel" class="app-sidepanel">
        ...
        <div class="sidepanel-inner d-flex flex-column">
            ...
            <div class="app-branding">
                <a class="app-logo" href="../admin/"><span class="logo-text">Travel in Prachuap</span></a>
            </div>
            <!--//app-branding-->
            ...
            <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
                <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                    ...
                    <li class="nav-item">
                        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                        <a class="nav-link <?php echo isset($_GET['page']) && $_GET['page']== 'phone' ? 'active' : '' ?>" href="?page=phone">
                            <span class="nav-icon">
                            ...
                            <span class="nav-link-text">จัดการข้อมูลเบอร์โทรฉุกเฉิน</span>
                        </a>
                        <!--//nav-link-->
                    </li>
                    <li class="nav-item">
                        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                        <a class="nav-link <?php echo isset($_GET['page']) && $_GET['page']== 'place' ? 'active' : '' ?>" href="?page=place">
                            <span class="nav-icon">
                            ...
                            <span class="nav-link-text">จัดการข้อมูลสถานที่</span>
                        </a>
                        <!--//nav-link-->
                    </li>
                    <li class="nav-item">
                        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                        <a class="nav-link <?php echo isset($_GET['page']) && $_GET['page']== 'placetype' ? 'active' : '' ?>" href="?page=placetype">
                            <span class="nav-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-richtext-fill" viewBox="0 0 16 16">
                                    <path d="M12 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2zM7 4.25a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0zm-.861 1.542 1.33.886 1.854-1.855a.25.25 0 0 1 .289-.047l1.888.974V7.5a.5.5 0 0 1-.5.5H5a.5.5 0 0 1-.5-.5V7s1.54-1.274 1.639-1.208zM5 9h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1 0-1zm0 2h3a.5.5 0 0 1 0 1H5a.5.5 0 0 1 0-1z"/>
                                </svg>
                            </span>
                            <span class="nav-link-text">จัดการข้อมูลประเภทสถานที่</span>
                        </a>
                        <!--//nav-link-->
                    </li>
                    <li class="nav-item">
