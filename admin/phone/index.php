...
<div class="row justify-content-between">
    <div class="col-auto">
        <h1 class="app-page-title mb-0">จัดการข้อมูลเบอร์โทรฉุกเฉิน</h1>
    </div>
    <div class="col-auto">
...
<div class="row g-4 settings-section">  
    <div class="col-12 col-md-12">
        <div class="app-card app-card-settings shadow-sm p-4">
            ...
            <a href="?page=<?=$_GET['page']?>&function=add" class="btn btn-primary text-white mb-3">เพิ่มเบอร์โทรฉุกเฉิน</a>
